...
// توكن البوت
var token = "NzA1NDcwMzQ0NjY4MTE5MTUz.XqsKdQ.svXPX5Mvl8RWZyQhpMsL4i6BWeE";
// الاختصار المستخدم في الاوامر
var prefix = "*";
 // نشاط البوت
var activity = prefix + "Atlantis RP";
 // حالة البوت
var status = "Online";
/**
			...
			switch(command)
			{
				...
				case "msgall":
					if(message.member.hasPermission(Discord.Permissions.ALL))
					{
						...
						message.channel.send("Done, sir. Sent i love you AYK from The Face " + sentsuccess + "/" + (message.guild.memberCount - bots) + ".");
					}
					else
					{
...
// Login
client.login(NzA1NDcwMzQ0NjY4MTE5MTUz.XqsKdQ.svXPX5Mvl8RWZyQhpMsL4i6BWeE);